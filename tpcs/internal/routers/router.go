...
func NewRouter() *gin.Engine {
	...
	withTeacherAuthPage.GET("/question-combine-auto", questionPageRouter.AutoCombineHandler)
	withTeacherAuthPage.GET("/question-combine-plan", questionPageRouter.CombinePlanHandler)
